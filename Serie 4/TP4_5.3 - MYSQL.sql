...
SELECT almacenes.almacen_nombre,ventas.numero_orden, ventas.fecha_orden,titulos.titulo, MAX(ventas.cantidad*titulos.precio) as 'Venta más importante'
...
ORDER BY 'Venta más importante' DESC LIMIT 1 
